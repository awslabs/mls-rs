...
mod test {
    ...
    fn test_empty_parent() {
        ...
        let expected = hex!("010000000066000000000000000000000001ff2a0003000000000000006\
    ...
    fn test_tree_hash() {
        ...
        let expected = hex!("010000000066000000000000000000000001ff2a00030000000000000062\
