...
fn main() -> Result<(), CustomError> {
    ...
    let key_package = alice_pc_client.generate_key_package_message(Default::default())?;
    ...
    let key_package = bob_tablet_client.generate_key_package_message(Default::default())?;
